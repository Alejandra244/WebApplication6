...
namespace WebApplication6.Controllers
{
    public class Genero_PeliculaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_GP,id_pelicula,id_genero,Dummy")] Genero_Pelicula genero_Pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_GP,id_pelicula,id_genero,Dummy")] Genero_Pelicula genero_Pelicula)
        {
            if (ModelState.IsValid)
            {
